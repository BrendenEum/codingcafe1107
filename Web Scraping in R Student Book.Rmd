---
title: "Web Scraping in R (Student Book)"
...
```{r}
release_dates <- html %>% ### YOUR CODE HERE ###
release_dates
```
...
```{r}
top_movies <- html %>% ### YOUR CODE HERE ###
...
## Exercise 6. Looping over multiple pages.

What if we want to get the highest grossing movie for each day of the week?
...
You are responsible for parsing through that html object and retrieving the table on that page. Put that data into a tibble called top_movies. In addition to that, please add a variable to the tibble called "day" for the day of the week.
...
```{r}
# So we don't mess around with the collected data, let's make a new object called pdata for our plot data.
